...
const UI = {
  "zh-TW": {
    ...
    paused: "重播已暫停",
    simulationTime: "模擬時間",
    playReplay: "啟動 synthetic replay；不會控制真實設備。",
    pauseReplay: "暫停 synthetic replay；不會暫停真實製程。",
    speedReplay: "每一秒現實時間推進的 synthetic ticks。",
    resetReplay: "清除目前 history 與 alarms，回到 tick 0。",
    normalReplay: "重播至 tick 60，建立無 fault 的正常製程基準。",
    jumpReplay: "重播至 fault 開始的 tick 120；下游偏移尚未完整形成。",
    heroReplay: "Demo shortcut：重播至 tick 220 並執行完整 Hero 調查。",
    currentInvestigation: "不改變 tick，直接調查目前 snapshot 與 history。",
    approvalRequest: "只送出 Action draft 核准申請；不會執行外部動作。",
  ...
  en: {
    ...
    playReplay: "Start synthetic replay; this does not control plant equipment.",
    pauseReplay: "Pause synthetic replay; this does not pause a plant process.",
    speedReplay: "Synthetic ticks advanced per second of wall-clock time.",
    resetReplay: "Clear current history and alarms and return to tick 0.",
    normalReplay: "Replay to tick 60 and prepare a fault-free normal baseline.",
    jumpReplay: "Replay to fault onset at tick 120, before the full downstream response.",
    heroReplay: "Demo shortcut: replay to tick 220 and run the complete Hero investigation.",
    currentInvestigation: "Keep the current tick and investigate the current snapshot and history.",
    approvalRequest: "Request approval for the Action draft only; no external action is dispatched.",
