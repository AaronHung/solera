...
4. `LOOP1_DEMO_MECHANICS_AND_PRODUCT_EVOLUTION.md`：tick、controls、Cases、
   Agent／LLM 邊界與產品演進。
5. `LOOP1_DATA_HUB_AGENT_FLOW.md`：Data Hub 功能與 Agent flow。
6. `LOOP1_VALUE_VALIDATION.md`：capability proof、customer KPI 與 follow-up。
7. `SOLERA_CUSTOMER_USE_CASES.md`：依產業、buyer 與成本選擇場景。
8. `LOOP1_DEMO_SOP.md`：完整技術操作與 troubleshooting。
